 ...
 *
 * Generated on Mon May 11 21:01:21 2020
 ...
 */
#include "custom_crc32.h"     /* include the header file generated with pycrc */
#include <stdlib.h>
#include <stdint.h>
...
//     printf(format, "poly", (unsigned long long int)0x04c11db7);
//     printf("%-16s = %s\n", "reflect_in", "true");
//     printf(format, "xor_in", (unsigned long long int)0xc55c0000);
//     printf("%-16s = %s\n", "reflect_out", "true");
//     printf(format, "xor_out", (unsigned long long int)0x00000000);
...
//     crc = crc_init();
//     crc = crc_update(crc, (void *)str, sizeof(str));
